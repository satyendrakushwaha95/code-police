  ...
  return (
    <aside className="sidebar" ref={sidebarRef} style={{ width: `${sidebarWidth}px` }}>
      ...
      <button className="new-chat-btn" onClick={handleNewChat}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 5v14M5 12h14"/></svg>
        New Chat / Agentic Task
      </button>

      <div className="sidebar-tools">
        <button className="sidebar-tool-btn" onClick={onOpenCodeGen} title="Code Generation">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/>
          </svg>
          <span>Code Generator</span>
        </button>
        <button className="sidebar-tool-btn" onClick={onOpenRefactor} title="Refactor Assistant">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M12 20h9"/>
        ...
        <button className="sidebar-tool-btn" onClick={onOpenDesignDoc} title="Design Documents">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button className="sidebar-tool-btn" onClick={onOpenPromptEnhancer} title="Prompt Enhancer">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <button className="sidebar-tool-btn" onClick={onToggleFilePanel} title="File Explorer">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/>
          </svg>
          <span>Files</span>
        </button>
        <button className="sidebar-tool-btn" onClick={onToggleTerminal} title="Terminal">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              {editingId === conv.id ? (
                ...
                <>
                  ...
                  <span className="conv-meta">
                    {conv.messages.length} msgs · {formatTimestamp(conv.updatedAt)}
                  </span>
                </>
              )}
            </div>
      ...
      <div className="sidebar-footer">
        <button className="sidebar-footer-btn" onClick={onOpenAgentPanel}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M12 2a2 2 0 012 2v2a2 2 0 01-2 2 2 2 0 01-2-2V4a2 2 0 012-2z"/>
            <path d="M16 8h-8a2 2 0 00-2 2v8a2 2 0 002 2h8a2 2 0 002-2V10a2 2 0 00-2-2z"/>
        ...
        <button className="sidebar-footer-btn" onClick={onOpenPipelinePanel}>
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 12h-4l-3 9L9 3l-3 9H2"/></svg>
          Task Pipeline
        </button>
        <button className="sidebar-footer-btn" onClick={onOpenUsage}>
